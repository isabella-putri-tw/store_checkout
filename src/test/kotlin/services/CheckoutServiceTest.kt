        ...
        fun `should print receipt with multiple items`() {
            ...
            assertThat(outputStreamCaptor.toString().trim()).isEqualTo(
                """
                    ...
                    │ Qty │ Name                       │ Price │ Tax  │ Total   │
                    ├─────┼────────────────────────────┼───────┼──────┼─────────┤
                    │ 1   │ imported bottle of perfume │ 27.99 │ 4.20 │   32.19 │
                    │ 1   │ bottle of perfume          │ 18.99 │ 1.90 │   20.89 │
                    │ 1   │ packet of headache pills   │ 9.75  │ 0    │    9.75 │
                    │ 1   │ imported box of chocolates │ 11.25 │ 0.60 │   11.85 │
                    ├─────┴────────────────────────────┴───────┴──────┼─────────┤
                    │                                       Sales tax │  $ 6.70 │
                    ├─────────────────────────────────────────────────┼─────────┤
                    │                                           Total │ $ 74.68 │
